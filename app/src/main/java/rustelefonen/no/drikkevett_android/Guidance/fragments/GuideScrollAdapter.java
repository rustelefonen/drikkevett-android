...
import rustelefonen.no.drikkevett_android.tabs.calc.fragments.BeerFragment;
import rustelefonen.no.drikkevett_android.tabs.calc.fragments.DrinkFragment;
import rustelefonen.no.drikkevett_android.tabs.calc.fragments.ShotFragment;
import rustelefonen.no.drikkevett_android.tabs.calc.fragments.WineFragment;
