...
public class SettingsDatepickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        EditText dateEditText = (EditText) getActivity().findViewById(R.id.goal_settings_date_edit_text);
